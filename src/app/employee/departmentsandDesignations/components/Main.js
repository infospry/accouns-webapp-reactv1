                ...
                <div className="body_scroll">
                    <div className="scrolfx">
                        <div className="booktab d-flex justify-content-between align-items-center bdrb">
                            <div className="p-2">
                                <h2 className="font-bold mb-0"><i class="zmdi zmdi-city-alt me-1"></i>  Departments and Designations</h2>
                            </div>
                                    ...
                                    <div class="inbox right rgtinbox  htg_auto"> 
                                        <div class="i_action d-flex justify-content-between align-items-center bdrt0 P-1">
                                            ...
                                            <div class="pagination-email">
                                                <div class="btn-group">                       
                                                    <a href="#" class="btn btn btn-success" data-toggle="modal" data-target="#addeditlocation"><i class="zmdi zmdi-plus-circle-o-duplicate"></i> Add New</a>
                                                ...
                                                <div class="bxsaddow h_4 mt-3">
                                                    <h4>
                                                        <span class="checkbox">
                                                            ...
                                                            <label for="l">
                                                                    <i class="zmdi zmdi-account"> </i> Adminstration
                                                            </label>
                                                        </span>                                                   
                                                        <span class="bubl-light ml-2">06</span>
                                                    ...
                                                    <div class="p-3 bdr1 h4show">
                                                        <p class="mb-1">
                                                            <span class="wd-16px">Department</span>
                                                            <span>:</span>
                                                            <span id="lblworkhospital">Adminstration</span>
                                                        </p>
                                                        <p class="mb-1">
                                                            <span class="wd-16px">Designation</span>
                                                            <span>:</span>
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-blu-lite">
                            ...
                            <h4 class="modal-title" id="myModalLabel2">
                                <b> <i class="zmdi zmdi-pin"></i> Add  Departments and Designations</b>
                            </h4>
                        </div>
                                    ...
                                    <div class="pagediv mt-4">
                                        <div class="row m-0"> 
                                            <div class="col-12 col-sm-6">   
                                                ...
                                                <div class="group_lead">
                                                    <input type="text" id="" class="input_text" required="required"/>
                                                    <label for="" class="lablefilled"> Departments</label>                                              
                                                </div>                                       
                                                <div class="group_lead">
                                                    <input type="text" id="" class="input_text" required="required"/>
