...
<div className='row justify-content-between'>
    {/* <div className="text-center"><h2 className="font-bold"> Account Details </h2></div> */}
    <div className="col-lg-8"> 
        ...
        <div class="saddow_box">                                  
        <div className="row">
            <div className="col-12"> <h2 className="font-bold"> Preferences </h2>
            <hr/>
            </div>
    ...
    <div className="col-lg-4 saddow_box">
        <div class="p-4">
        <div className="form-group text-start row align-items-center justify-content-center">
            <label className="form-label mt-3 text-center col-lg-12"><b>Upload Your Photo</b></label>
            <div class=" col-lg-12">
