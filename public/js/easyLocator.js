...
(function ( $ ) {  
    ...
    this.easyLocatorMethods = {
       ...
       loadScripts : function(container) { 
          ...
          var scriptMapUrl = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCcXcGv2klxBHhKTuoGIgiiJL0u7L-hBZY&libraries=places' +
          ...
          if(typeof google === 'object' && typeof google.maps === 'object') {
             ...
             if(typeof this.options.apiKey !== 'undefined') {
                scriptMapUrl = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCcXcGv2klxBHhKTuoGIgiiJL0u7L-hBZY&libraries=places' +
       ...
       loadMap : function() {     
          ...
          if(this.options.contentTemplate == '') {            
             this.options.infoWindow = new google.maps.InfoWindow({ maxWidth: 440 }); 
       ...
       createButtonList: function(controlDiv) {
          ...
          var buttonOpenList = $.parseHTML('<div id="locatorMap_openList"><i class="zmdi zmdi-list"></i></div>')[0];        
       ...
       getContentITemList: function(info) {
          ...
          if(info.iconMarker == '' || typeof info.iconMarker == 'undefined' ) {
             htmlContent = htmlContent.replace('<span class="ocatorMap_list_itemPlaceHolder"></span>','<i class="locatorMap_list_item_icon zmdi zmdi-accounts-list"></i>')
          }
       ...
       openInfoWindow: function(location) {
          ...
          if(location.link != '') {
              locationLink = '<p><a href="mailto:' + location.link + '" target="_blank"><i class="fa fa-envelope"> </i> Email Address</a></p>';
          }
