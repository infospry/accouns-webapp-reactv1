(function (t, e) {
    ...
    function s(t, e, a) {
            ...
            (s.style[p("transform")] = a.arrowTransform),
                "round" === a.arrowType
                    ? (s.classList.add("tippy-roundarrow"),
                        (s.innerHTML = '<svg viewBox="0 0 24 8" xmlns="http://www.w3.org/2000/svg"><path d="M3 8s2.021-.015 5.253-4.218C9.584 2.051 10.797 1.007 12 1c1.203-.007 2.416 1.035 3.761 2.782C19.012 8.005 21 8 21 8H3z"/></svg>'))
        ...
        if (d) {
            var c;
            d instanceof Element ? (r.appendChild(d), (c = "#" + (d.id || "tippy-html-template"))) : ((r.innerHTML = document.querySelector(d).innerHTML), (c = d)),
    ...
    function l(t, e, a, i) {
        ...
        return (
            i.target
                ? (qt.supportsTouch && i.touchHold && (d("touchstart", n), d("touchend", s)), "mouseenter" === t && (d("mouseover", n), d("mouseout", s)), "focus" === t && (d("focusin", n), d("focusout", s)), "click" === t && d("click", n))
                : (d(t, o), qt.supportsTouch && i.touchHold && (d("touchstart", o), d("touchend", r)), "mouseenter" === t && d("mouseleave", r), "focus" === t && d(Ft ? "focusout" : "blur", p)),
            l
        );
    }
    function d(t, e) {
    ...
    function st(t, e) {
        var a,
            ...
            s = o.split("-")[0];
        return (
            (a = tt(+i) ? [+i, 0] : nt(i, p, n, s)),
            "left" === s ? ((p.top += a[0]), (p.left -= a[1])) : "right" === s ? ((p.top += a[0]), (p.left += a[1])) : "top" === s ? ((p.left += a[0]), (p.top -= a[1])) : "bottom" === s && ((p.left += a[0]), (p.top += a[1])),
            (t.popper = p),
            t
        );
    }
            ...
            onTrigger: function (e) {
                if (t.state.enabled) {
                    ...
                    (a && t.options.touchHold) ||
                        ((t._(be).lastTriggerEvent = e), "click" === e.type && "persistent" !== t.options.hideOnClick && t.state.visible ? Ot.call(t) : Lt.call(t, e), a && qt.iOS && t.reference.click && t.reference.click());
                }
            },
        ...
        var t = this,
            ...
            l = Jt({ placement: i.placement }, p || {}, {
                modifiers: Jt({}, p ? p.modifiers : {}, {
                    ...
                    flip: Jt({ enabled: i.flip, padding: i.distance + 5, behavior: i.flipBehavior }, p && p.modifiers ? p.modifiers.flip : {}),
    ...
    function St(t) {
        ...
        if (
            (this.popperInstance
                ? (this.popperInstance.scheduleUpdate(), e.livePlacement && !Et.call(this) && this.popperInstance.enableEventListeners())
                : ((this.popperInstance = Ct.call(this)), !e.livePlacement && this.popperInstance.disableEventListeners()),
                !Et.call(this))
        ) {
            var a = m(this.popper),
                i = a.arrow;
    ...
    for (
        var jt = { POPPER: ".tippy-popper", TOOLTIP: ".tippy-tooltip", CONTENT: ".tippy-content", BACKDROP: ".tippy-backdrop", ARROW: ".tippy-arrow", ROUND_ARROW: ".tippy-roundarrow", REFERENCE: "[data-tippy]" },
        Kt = {
            placement: "top",
            livePlacement: !0,
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        var p,
                            ...
                            b = j("transform");
                        if (((n = "bottom" == f ? -d.height + m.bottom : m.top), (p = "right" == h ? -d.width + m.right : m.left), s && b))
                            (c[b] = "translate3d(" + p + "px, " + n + "px, 0)"), (c[f] = 0), (c[h] = 0), (c.willChange = "transform");
                        else {
                            var u = "bottom" == f ? -1 : 1,
                                y = "right" == h ? -1 : 1;
                        ...
                        value: function (t) {
                            ...
                            if (!this.state.destroyed && this.state.enabled) {
                                var a = this.popper,
                                    ...
                                    s = r.backdrop,
                                    l = r.content;
                                return (o.dynamicTitle && !i.getAttribute("data-original-title")) || i.hasAttribute("disabled")
                                    ? void 0
                                    ...
                                    yt(function () {
                                        It.call(e, t, function () {
                                            e.state.visible ||
                                                ...
                                                (!e._(be).isPreparingToShow && (document.removeEventListener("mousemove", e._(be).followCursorListener), (e._(be).lastMouseMoveEvent = null)),
